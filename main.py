...
def get_dataset(opts):
    ...
    if opts.dataset=='cityscapes':
        ...
        val_dst = Cityscapes(root=opts.data_root, split='test', transform=val_transform)
...
def main():
    ...
    val_loader = data.DataLoader(val_dst, batch_size=opts.batch_size if opts.crop_val else 1 , shuffle=True, num_workers=4)
